...
void MakeBinStudyHistos(TString configfileinput="sbs4_30p_cuts"){ // main
  ...
  // 8m / 800 = 0.01 = 1 cm
  C->Draw("hcal_dx>>hcal_dx_1d_allcuts_0p01(800, -4, 4)",  allcuts_study_string.c_str(), "COLZ");
  ...
  if (hcal_dx_1d_allcuts_0p01) {
   ...
   // 8m / 400 = 0.02 = 2 cm
  C->Draw("hcal_dx>>hcal_dx_1d_allcuts_0p02(400, -4, 4)",  allcuts_study_string.c_str(), "COLZ");
  // Retrieve and customize histogram
  ...
  if (hcal_dx_1d_allcuts_0p02) {
    ...
    // 6m / 200 = 0.03 = 3 cm
  C->Draw("hcal_dx>>hcal_dx_1d_allcuts_0p03(200, -3, 3)",  allcuts_study_string.c_str(), "COLZ");
  // Retrieve and customize histogram
  ...
  if (hcal_dx_1d_allcuts_0p03) {
    ...
    // 8m / 200 = 0.04 m= 4 cm
  C->Draw("hcal_dx>>hcal_dx_1d_allcuts_0p04(200, -4, 4)",  allcuts_study_string.c_str(), "COLZ");
  // Retrieve and customize histogram
  ...
  if (hcal_dx_1d_allcuts_0p04) {
    hcal_dx_1d_allcuts_0p04->SetXTitle("hcal_dx");
      ...
      // 10m / 200 = 0.05 m= 5 cm
  C->Draw("hcal_dx>>hcal_dx_1d_allcuts_0p05(200, -5, 5)",  allcuts_study_string.c_str(), "COLZ");
  // Retrieve and customize histogram
  ...
  C->Draw("hcal_dx>>hcal_dx_1d_allcuts_0p001(8000, -4, 4)",  allcuts_study_string.c_str(), "COLZ");
  // Retrieve and customize histogram
  ...
  C->Draw("hcal_dx>>hcal_dx_1d_allcuts_0p005(2000, -5, 5)",  allcuts_study_string.c_str(), "COLZ");
  // Retrieve and customize histogram
 ...
 //  C->Draw("hcal_dx>>hcal_dx_1d_allcuts_50(50, -4, 4)",  allcuts_study_string.c_str(), "COLZ");
 //  // Retrieve and customize histogram
 ...
 //  C->Draw("hcal_dx>>hcal_dx_1d_allcuts_100(100, -4, 4)",  allcuts_study_string.c_str(), "COLZ");
 //  // Retrieve and customize histogram
 ...
 //  C->Draw("hcal_dx>>hcal_dx_1d_allcuts_200(200, -4, 4)", allcuts_study_string.c_str(), "COLZ");
 //  // Retrieve and customize histogram
 ...
 //   C->Draw("hcal_dx>>hcal_dx_1d_allcuts_300(300, -4, 4)", allcuts_study_string.c_str(), "COLZ");
 //  // Retrieve and customize histogram
 ...
 //  C->Draw("hcal_dx>>hcal_dx_1d_allcuts_400(400, -4, 4)",  allcuts_study_string.c_str(), "COLZ");
 //  // Retrieve and customize histogram
 ...
 //  C->Draw("hcal_dx>>hcal_dx_1d_allcuts_500(500, -4, 4)",  allcuts_study_string.c_str(), "COLZ");
 //  // Retrieve and customize histogram
 ...
 //  C->Draw("hcal_dx>>hcal_dx_1d_allcuts_700(700, -4, 4)", allcuts_study_string.c_str(), "COLZ");
 //  // Retrieve and customize histogram
 ...
 //  C->Draw("hcal_dx>>hcal_dx_1d_allcuts_800(800, -4, 4)", allcuts_study_string.c_str(), "COLZ");
 //  // Retrieve and customize histogram
 ...
 //  C->Draw("hcal_dx>>hcal_dx_1d_allcuts_900(900, -4, 4)",  allcuts_study_string.c_str(), "COLZ");
 //  // Retrieve and customize histogram
 ...
 //  C->Draw("hcal_dx>>hcal_dx_1d_allcuts_1000(1000, -4, 4)",  allcuts_study_string.c_str(), "COLZ");
 //  // Retrieve and customize histogram
 ...
 //   C->Draw("hcal_dx>>hcal_dx_1d_allcuts_1100(1100, -4, 4)",  allcuts_study_string.c_str(), "COLZ");
 //  // Retrieve and customize histogram
 ...
 //  C->Draw("hcal_dx>>hcal_dx_1d_allcuts_1200(1200, -4, 4)",  allcuts_study_string.c_str(), "COLZ");
 //  // Retrieve and customize histogram
 ...
 // C->Draw("hcal_dx>>hcal_dx_1d_allcuts_1300(1300, -4, 4)",  allcuts_study_string.c_str(), "COLZ");
 //  // Retrieve and customize histogram
 ...
 //   C->Draw("hcal_dx>>hcal_dx_1d_allcuts_1400(1400, -4, 4)",  allcuts_study_string.c_str(), "COLZ");
 //  // Retrieve and customize histogram
 ...
 // C->Draw("hcal_dx>>hcal_dx_1d_allcuts_1500(1500, -4, 4)",  allcuts_study_string.c_str(), "COLZ");
 //  // Retrieve and customize histogram
