...
void dxdy_simc_v4(int entries_input = -1, TString configfileinput="sbs4_30p_simc"){//main
 ...
 //  TCanvas* testcanvas =  new TCanvas("testcanvas", "testcanvas");
  
 // // Create and draw the first box (in red, line width 2)
 //    std::vector<TLine*> box = utilityHandler.CreateBox(hcalaa, kRed, 2);
 //    h_xy_HCAL_passedFid_p->Draw("colz");
 //    for (auto* line : box) {
 //        line->Draw();
 //    }
