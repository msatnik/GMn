...
void hcal_e_stability_v2(){ // main
  ...
  SliceAndProjectHistogram_xMaxFixed(hist_2D_proton, xSlices, hist_vector_p, max, "hcal_e","dx","p");
  SliceAndProjectHistogram_xMaxFixed(hist_2D_neutron, xSlices, hist_vector_n, max, "hcal_e","dx","n");
  SliceAndProjectHistogram_xMaxFixed(hist_2D_data, xSlices, hist_vector_data, max, "hcal_e","dx","data");
  ...
  customizeGraph(Rsf_graph, 33, kBlue, 3,"","hcal_e","Rsf");
  void customizeGraph(TGraphErrors *graph, int markerStyle, int markerColor, double markerSize, 
		      const char* graphTitle, const char* xAxisLabel, const char* yAxisLabel);
