...
void hcal_e_stability_slices(){ // main
  ...
  TString outputfilename = "../output/hcal_e_stability_2_test.root";
  ...
  //std::vector<double> xSlices ={0.015,0.017,0.019,0.021,0.023,0.025,0.027,0.029,0.031,0.033,0.035,0.037,0.039};
  //std::vector<double> xSlices ={0.015,0.019,0.023,0.027,0.031,0.035,0.039,0.043};
  // std::vector<double> xSlices ={0.017,0.021,0.025,0.029,0.033,0.037,0.041,0.045,0.049,0.053,0.057};
  std::vector<double> xSlices ={0.015,0.025,0.035,0.045,0.055,0.065,0.075,0.085,0.095,0.105,0.115};
  ...
  SliceAndProjectHistogram_slices(hist_2D_proton, xSlices, hist_vector_p, "hcal_e","dx","p");
  SliceAndProjectHistogram_slices(hist_2D_neutron, xSlices, hist_vector_n, "hcal_e","dx","n");
  SliceAndProjectHistogram_slices(hist_2D_data, xSlices, hist_vector_data, "hcal_e","dx","data");
  ...
  customizeGraph(Rsf_graph, 33, kBlue, 3,"","hcal_e min","Rsf");
  void customizeGraph(TGraphErrors *graph, int markerStyle, int markerColor, double markerSize, 
		      const char* graphTitle, const char* xAxisLabel, const char* yAxisLabel);
