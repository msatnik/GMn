...
void dxdy(int entries_input = -1, int kine = 4 ){//main
  ...
  //// set location to config file
   ...
   string configfilename = "/w/halla-scshelf2102/sbs/msatnik/GMn/config/sbs4_50p.cfg";

   // Declare outfile
   // TFile *fout = new TFile( Form("../output/sbs%d.root",kine), "RECREATE" );
  TFile *fout = new TFile("../output/sbs4_50p.root", "RECREATE" );
