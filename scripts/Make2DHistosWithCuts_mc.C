...
void Make2DHistosWithCuts_mc(TString configfileinput="sbs4_30p_test_mc"){ // main
  ...
  // preshower energy  vs dx study
  std::string ps_e_study_string = TrackQualityCutString + "&&"+TargetVertexCutString +"&&" +W2CutString+ "&&"+FidXCutString +"&&"+ FidYCutString + "&&"+e_over_p_CutString + "&&"+ HCal_Energy_CutString + "&&"+dyCutString+ "&&" +Optics_CutString;
  //// Draw the 2D histogram
  C->Draw("hcal_dx:bb_ps_e>>hcal_dx__ps_e(200, 0, 2, 400, -4, 4)", Form("corrected_weight*(%s)",ps_e_study_string.c_str()), "COLZ");
  ...
  std::string ps_e_W2_study_string =  TrackQualityCutString + "&&"+TargetVertexCutString + "&&"+FidXCutString +"&&"+ FidYCutString + "&&"+e_over_p_CutString + "&&"+ HCal_Energy_CutString +"&&" + dyCutString+ "&&" +Optics_CutString; 
  //// Draw the 2D histogram
  C->Draw("W2:bb_ps_e>>W2__ps_e(200, 0, 2, 300, 0, 3)",  Form("corrected_weight*(%s)",ps_e_W2_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  //// target vertext vs dx study
  std::string target_vertex_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&" +W2CutString+ "&&"+FidXCutString +"&&"+ FidYCutString + "&&"+e_over_p_CutString + "&&"+ HCal_Energy_CutString+ "&&"+dyCutString+ "&&" +Optics_CutString;
  //// Draw the 2D histogram
  C->Draw("hcal_dx:bb_tr_vz>>hcal_dx__tr_vz(200, -0.1, 0.1, 400, -4, 4)", Form("corrected_weight*(%s)",target_vertex_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  std::string target_vertex_W2_study_string = EnergyCutString + "&&"+ TrackQualityCutString +  "&&"+FidXCutString +"&&"+ FidYCutString + "&&"+e_over_p_CutString + "&&"+ HCal_Energy_CutString +"&&"+ dyCutString+ "&&" +Optics_CutString;
  //// Draw the 2D histogram
  C->Draw("W2:bb_tr_vz>>W2__tr_vz(200, -0.1, 0.1, 300, 0, 3)", Form("corrected_weight*(%s)", target_vertex_W2_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  /// W2 vs dx 
  std::string W2_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString +"&&" +FidXCutString +"&&"+ FidYCutString + "&&"+e_over_p_CutString + "&&"+ HCal_Energy_CutString+ "&&"+dyCutString+ "&&" +Optics_CutString;
  //// Draw the 2D histogram
  C->Draw("hcal_dx:W2>>hcal_dx__W2(300, 0, 3, 400, -4, 4)", Form("corrected_weight*(%s)",W2_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  TH2D *hcal_dx__W2 = (TH2D*)gDirectory->Get("hcal_dx__W2");
  if (hcal_dx__W2) {
    hcal_dx__W2->SetXTitle("W2");
    hcal_dx__W2->SetYTitle("hcal_dx");
  }

  //// fiducial x vs dx 
  std::string FidX_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString +"&&" +W2CutString+ "&&"+ FidYCutString + "&&"+e_over_p_CutString + "&&"+ HCal_Energy_CutString+ "&&"+dyCutString+ "&&" +Optics_CutString;
  //// Draw the 2D histogram
  C->Draw("hcal_dx:nsigx_fid>>hcal_dx__nsigx_fid(200, -10, 10, 400, -4, 4)", Form("corrected_weight*(%s)",FidX_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  // fiducial x vs W2 
  std::string FidX_W2_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString + "&&"+ FidYCutString + "&&"+e_over_p_CutString + "&&"+ HCal_Energy_CutString +"&&"+ dyCutString+ "&&" +Optics_CutString; 
  //// Draw the 2D histogram
  C->Draw("W2:nsigx_fid>>W2__nsigx_fid(200, -10, 10, 300, 0, 3)",Form("corrected_weight*(%s)",FidX_W2_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  /// fiducial y vs dx 
  std::string FidY_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString +"&&" +W2CutString+ "&&"+ FidXCutString + "&&"+e_over_p_CutString + "&&"+ HCal_Energy_CutString + "&&"+dyCutString+ "&&" +Optics_CutString;
  //// Draw the 2D histogram
  C->Draw("hcal_dx:nsigy_fid>>hcal_dx__nsigy_fid(50, -1, 4, 400, -4, 4)", Form("corrected_weight*(%s)",FidY_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  /// fiducial y vs W2
  std::string FidY_W2_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString + "&&"+ FidXCutString + "&&"+e_over_p_CutString + "&&"+ HCal_Energy_CutString + "&&"+dyCutString+ "&&" +Optics_CutString;
  //// Draw the 2D histogram
  C->Draw("W2:nsigy_fid>>W2__nsigy_fid(50, -1, 4, 300, 0, 3)",Form("corrected_weight*(%s)", FidY_W2_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  // hcal_x vs dx 
  std::string hcal_x_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString +"&&" +W2CutString+ "&&"+ FidYCutString + "&&"+e_over_p_CutString + "&&"+ HCal_Energy_CutString +"&&"+ dyCutString +"&&" +  Optics_CutString ;
  //// Draw the 2D histogram
  C->Draw("hcal_dx:hcal_x>>hcal_dx__hcal_x(450, -3, 1.5, 400, -4, 4)",Form("corrected_weight*(%s)",hcal_x_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  // hcal_x vs W2
  std::string hcal_x_W2_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString +"&&" + FidYCutString + "&&"+e_over_p_CutString + "&&"+ HCal_Energy_CutString +"&&"+ dyCutString +"&&" +  Optics_CutString ;
  //// Draw the 2D histogram
  C->Draw("W2:hcal_x>>W2__hcal_x(450, -3, 1.5, 300, 0, 3)",Form("corrected_weight*(%s)",hcal_x_W2_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  // hcal_x_exp vs dx 
  std::string hcal_x_exp_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString +"&&" +W2CutString+ "&&"+ FidYCutString + "&&"+e_over_p_CutString + "&&"+ HCal_Energy_CutString +"&&"+ dyCutString +"&&" +  Optics_CutString;
  //// Draw the 2D histogram
  C->Draw("hcal_dx:hcal_x_exp>>hcal_dx__hcal_x_exp(450, -2, 2.5, 400, -4, 4)",Form("corrected_weight*(%s)",hcal_x_exp_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  // hcal_x_exp vs W2
  std::string hcal_x_exp_W2_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString +"&&" + FidYCutString + "&&"+e_over_p_CutString + "&&"+ HCal_Energy_CutString +"&&"+ dyCutString +"&&" +  Optics_CutString;
  //// Draw the 2D histogram
  C->Draw("W2:hcal_x_exp>>W2__hcal_x_exp(450, -2, 2.5, 300, 0, 3)",Form("corrected_weight*(%s)",hcal_x_exp_W2_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  // hcal_x_exp vs hcal_y_exp
  std::string hcal_x_exp_hcal_y_exp_study_string_allcuts = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString +  "&&"+e_over_p_CutString + "&&"+ HCal_Energy_CutString +"&&"+ dyCutString +"&&" +  Optics_CutString ;
  //// Draw the 2D histogram
  C->Draw("hcal_x_exp:hcal_y_exp>>hcal_x_exp__hcal_y_exp_allcuts(400, -2, 2, 600, -3, 3)" ,Form("corrected_weight*(%s)",hcal_x_exp_hcal_y_exp_study_string_allcuts.c_str()), "COLZ");
  // Retrieve and customize histogram
  TH2D *hcal_x_exp__hcal_y_exp_allcuts= (TH2D*)gDirectory->Get("hcal_x_exp__hcal_y_exp_allcuts");
  if (hcal_x_exp__hcal_y_exp_allcuts) {
    hcal_x_exp__hcal_y_exp_allcuts->SetXTitle("hcal_y_exp");
    hcal_x_exp__hcal_y_exp_allcuts->SetYTitle("hcal_x_exp");
  }
  ...
  //// Draw the 2D histogram
  C->Draw("hcal_dx:hcal_y>>hcal_dx__hcal_y(200, -1, 1, 400, -4, 4)",Form("corrected_weight*(%s)",hcal_x_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  // hcal_y vs W2
  std::string hcal_y_W2_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString +"&&" + FidXCutString + "&&"+e_over_p_CutString + "&&"+ HCal_Energy_CutString +"&&"+ dyCutString +"&&" +  Optics_CutString;
  //// Draw the 2D histogram
  C->Draw("W2:hcal_y>>W2__hcal_y(200, -1, 1, 300, 0, 3)",Form("corrected_weight*(%s)",hcal_y_W2_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  // hcal_y_exp vs dx 
  std::string hcal_y_exp_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString+"&&" +W2CutString+ "&&"+ FidXCutString + "&&"+e_over_p_CutString + "&&"+ HCal_Energy_CutString +"&&"+ dyCutString +"&&" +  Optics_CutString ;
  //// Draw the 2D histogram
  C->Draw("hcal_dx:hcal_y_exp>>hcal_dx__hcal_y_exp(200, -1, 1, 400, -4, 4)",Form("corrected_weight*(%s)", hcal_y_exp_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  // hcal_y_exp vs W2
  std::string hcal_y_exp_W2_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString +"&&" + FidXCutString + "&&"+e_over_p_CutString + "&&"+ HCal_Energy_CutString +"&&"+ dyCutString +"&&" +  Optics_CutString;  //// Draw the 2D histogram
  C->Draw("W2:hcal_y_exp>>W2__hcal_y_exp(200, -1, 1, 300, 0, 3)",Form("corrected_weight*(%s)", hcal_y_exp_W2_study_string.c_str() ), "COLZ");
  // Retrieve and customize histogram
  ...
  // e/p vs dx
  std::string e_over_p_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString +"&&" +W2CutString+ "&&"+ FidXCutString + "&&"+ FidYCutString + "&&"+ HCal_Energy_CutString+ "&&"+dyCutString + "&&"+ Optics_CutString;
  //// Draw the 2D histogram
  C->Draw("hcal_dx:e_over_p>>hcal_dx__e_over_p(400, -1, 3, 400, -4, 4)", Form("corrected_weight*(%s)",e_over_p_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  // e/p vs W2
  std::string e_over_p_W2_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString + "&&"+ FidXCutString + "&&"+ FidYCutString + "&&"+ HCal_Energy_CutString +"&&"+ dyCutString + "&&" +Optics_CutString; 
  //// Draw the 2D histogram
  C->Draw("W2:e_over_p>>W2__e_over_p(400, -1, 3, 300, 0, 3)",  Form("corrected_weight*(%s)",e_over_p_W2_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  //// hcal energy vs dx study 
  std::string hcal_e_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString +"&&" +W2CutString+ "&&"+ FidXCutString + "&&"+ FidYCutString +"&&"+e_over_p_CutString+ "&&"+dyCutString + "&&" +Optics_CutString;
  //// Draw the 2D histogram
  C->Draw("hcal_dx:hcal_e>>hcal_dx__hcal_e(2000, 0, 2, 400, -4, 4)", Form("corrected_weight*(%s)",hcal_e_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  /// hcal energy vs W2
  std::string hcal_e_W2_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString + "&&"+ FidXCutString + "&&"+ FidYCutString +"&&"+e_over_p_CutString +"&&"+ dyCutString+ "&&" +Optics_CutString ; 
  //// Draw the 2D histogram
  C->Draw("W2:hcal_e>>W2__hcal_e(2000, 0, 2, 300, 0, 3)", Form("corrected_weight*(%s)",hcal_e_W2_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  // dy study
  std::string dy_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString +"&&" +W2CutString+ "&&"+ FidXCutString + "&&"+ FidYCutString +"&&"+e_over_p_CutString +  "&&"+ HCal_Energy_CutString + "&&" +Optics_CutString;
  //// Draw the 2D histogram
  C->Draw("hcal_dx:hcal_dy>>hcal_dx__hcal_dy(100, -2, 2, 400, -4, 4)", Form("corrected_weight*(%s)",dy_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  //// Draw the 2D histogram
  C->Draw("hcal_dx:hcal_dy/dysig>>hcal_dx__hcal_nsigdy(100, -5, 5, 400, -4, 4)", Form("corrected_weight*(%s)",dy_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  // dy vs W2 study
  std::string dy_W2_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString + "&&"+ FidXCutString + "&&"+ FidYCutString +"&&"+e_over_p_CutString +  "&&"+ HCal_Energy_CutString+ "&&" +Optics_CutString ;
  //// Draw the 2D histogram
  C->Draw("W2:hcal_dy>>W2__hcal_dy(100, -2, 2, 300, 0, 3)", Form("corrected_weight*(%s)",dy_W2_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  TH2D *W2__hcal_dy= (TH2D*)gDirectory->Get("W2__hcal_dy");
  if (W2__hcal_dy) {
    W2__hcal_dy->SetXTitle("hcal_dy");
    W2__hcal_dy->SetYTitle("W2");
  }

  // dy in terms of the number of sigma 
  //// Draw the 2D histogram
  C->Draw("W2:hcal_dy/dysig>>W2__hcal_nsigdy(100, -5, 5, 300, 0, 3)", Form("corrected_weight*(%s)",dy_W2_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  TH2D *W2__hcal_nsigdy= (TH2D*)gDirectory->Get("W2__hcal_nsigdy");
  if (W2__hcal_nsigdy) {
    W2__hcal_nsigdy->SetXTitle("nsigma_dy");
    W2__hcal_nsigdy->SetYTitle("W2");
  }

  // optics x vs dx study
  std::string optics_x_study_string=TargetVertexCutString;
  // std::string optics_x_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString +"&&" +W2CutString+ "&&"+ FidXCutString + "&&"+ FidYCutString +"&&"+e_over_p_CutString +  "&&"+ HCal_Energy_CutString+"&&"+ dyCutString;
  //// Draw the 2D histogram
  C->Draw("hcal_dx:bb_tr_r_x-0.9*bb_tr_r_th>>hcal_dx__optics_x(120, -0.6, 0.6, 400, -4, 4)", Form("corrected_weight*(%s)",optics_x_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  // std::string optics_x_W2_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString + "&&"+ FidXCutString + "&&"+ FidYCutString +"&&"+e_over_p_CutString +  "&&"+ HCal_Energy_CutString+"&&"+ dyCutString;
  //// Draw the 2D histogram
  C->Draw("W2:bb_tr_r_x-0.9*bb_tr_r_th>>W2__optics_x(120, -0.6, 0.6, 300, 0, 3)", Form("corrected_weight*(%s)",optics_x_W2_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  //std::string optics_y_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString +"&&" +W2CutString+ "&&"+ FidXCutString + "&&"+ FidYCutString +"&&"+e_over_p_CutString +  "&&"+ HCal_Energy_CutString+"&&"+ dyCutString;
  //// Draw the 2D histogram
  C->Draw("hcal_dx:bb_tr_r_y-0.9*bb_tr_r_ph>>hcal_dx__optics_y(150, -0.15, 0.15, 400, -4, 4)", Form("corrected_weight*(%s)",optics_y_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  // std::string optics_y_W2_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString + "&&"+ FidXCutString + "&&"+ FidYCutString +"&&"+e_over_p_CutString +  "&&"+ HCal_Energy_CutString+"&&"+ dyCutString;
  //// Draw the 2D histogram
  C->Draw("W2:bb_tr_r_y-0.9*bb_tr_r_ph>>W2__optics_y(130, -0.15, 0.15, 300, 0, 3)", Form("corrected_weight*(%s)",optics_y_W2_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  /// 1d histo of dy
  std::string allcuts_dy_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString +"&&" +W2CutString+ "&&"+ FidXCutString + "&&"+ FidYCutString +"&&"+e_over_p_CutString +  "&&"+ HCal_Energy_CutString +"&&" + Optics_CutString;
  C->Draw("hcal_dy>>hcal_dy_1d_allcuts(200, -2, 2)", Form("corrected_weight*(%s)", allcuts_dy_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  C->Draw("hcal_dy>>hcal_dy_1d_no_extra_cuts(200, -2, 2)", "corrected_weight", "COLZ");
  // Retrieve and customize histogram
  ...
  std::string allcuts_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString +"&&" +W2CutString+ "&&"+ FidXCutString + "&&"+ FidYCutString +"&&"+e_over_p_CutString +  "&&"+ HCal_Energy_CutString+ "&&"+dyCutString+ "&&" +Optics_CutString ;
  //// Draw the 1D histogram
  C->Draw("hcal_dx>>hcal_dx_1d_allcuts(400, -4, 4)", Form("corrected_weight*(%s)", allcuts_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  //// Draw the 1D histogram
  C->Draw("hcal_dx>>hcal_dx_1d_no_extra_cuts(400, -4, 4)", "corrected_weight", "COLZ");
  // Retrieve and customize histogram
  ...
  /// 1d histo of W2
  std::string allcuts_W2_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString + "&&"+ FidXCutString + "&&"+ FidYCutString +"&&"+e_over_p_CutString +  "&&"+ HCal_Energy_CutString + +"&&"+ dyCutString + "&&" +Optics_CutString; 
  //// Draw the 2D histogram
  C->Draw("W2>>W2_1d_allcuts(300, 0, 3)", Form("corrected_weight*(%s)", allcuts_W2_study_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  /// 1d histo of Q2
  std::string allcuts_Q2_study_string = EnergyCutString + "&&"+ TrackQualityCutString + "&&"+TargetVertexCutString+"&&" +W2CutString+ + "&&"+ FidXCutString + "&&"+ FidYCutString +"&&"+e_over_p_CutString +  "&&"+ HCal_Energy_CutString + +"&&"+ dyCutString +"&&" + Optics_CutString;
  //// Draw the 2D histogram
  C->Draw("Q2>>Q2_1d_allcuts(1000, 0, 10)",  Form("corrected_weight*(%s)",allcuts_Q2_study_string.c_str() ), "COLZ");
  // Retrieve and customize histogram
  ...
  //// Draw the 2D histogram
  C->Draw("hcal_dx:hcal_dy>>hcal_dx__hcal_dy_protonspot(100, -2, 2, 400, -4, 4)", Form("corrected_weight*(%s)", p_spot_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  //// Draw the 2D histogram
  C->Draw("hcal_dx:hcal_dy>>hcal_dx__hcal_dy_neutronspot(100, -2, 2, 400, -4, 4)",  Form("corrected_weight*(%s)",n_spot_string.c_str()), "COLZ");
  // Retrieve and customize histogram
  ...
  //     /// will do this in other programs insead  
